...
The mean of the total number of steps taken per day is `r sprintf("%.2f", newmean)` and the median is `r sprintf("%.2f", newmedian)`, which are larger than those obtained when the missing data were not considered or replaced.
